 ...
 */
package it.geosolutions.imageio.plugins.jp2openjpeg;
...
/**
 * Testing reading capabilities for {@link JP2GDALOpenJPEG ImageReader} leveraging
 * on JAI.
 * 
...
public class JP2KReadTest extends AbstractGDALTest {
	...
	protected static boolean isJp2OpenJPEGDriverAvailable;
    ...
    static {
        if (isGDALAvailable){
	        ...
	        isJp2OpenJPEGDriverAvailable = GDALUtilities.isDriverAvailable("JP2OpenJPEG");
        } else {
            isJp2OpenJPEGDriverAvailable = false;
        }
        if (!isJp2OpenJPEGDriverAvailable){
            AbstractGDALTest.missingDriverMessage("JP2OpenJPEG");
        }
    }
    ...
    public void read() throws FileNotFoundException, IOException {
        ...
        pbjImageRead.setParameter("Reader", new JP2GDALOpenJPEGImageReaderSpi()
