...
public class JP2GDALOpenJPEGImageReaderSpi extends GDALImageReaderSpi {
    ...
    private static final Logger LOGGER = Logger
            .getLogger("it.geosolutions.imageio.plugins.jp2openjpeg");
    ...
    static final String readerCN = "it.geosolutions.imageio.plugins.jp2openjpeg.JP2GDALOpenJPEGImageReader";
    ...
    public JP2GDALOpenJPEGImageReaderSpi() {
        ...
        if (LOGGER.isLoggable(Level.FINE))
            LOGGER.fine("JP2GDALOpenJPEGImageReaderSpi Constructor");
    }
    ...
    /**
     * Returns an instance of the JP2GDALOpenJPEGImageReader
     * 
